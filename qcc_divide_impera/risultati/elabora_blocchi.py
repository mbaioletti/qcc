import pandas as pd
df=pd.read_csv("blocco_sw_accurate_10.csv")
...
#tab_sw.to_csv("tabella_pivot_dim_sw.csv")
#print("Numero di chunk per gli swap")
#print(tab_sw)

df=pd.read_csv("blocco_de_accurate_10.csv")
...
#print(tab_de)
#tab_de.to_csv("tabella_pivot_dim_de.csv")
